#!/usr/bin/env bash
# ============================================================
# FIX 052 — DOC: config count drift (57 -> 69) in v15R2 docs/gates
#   Registry has 69 params; v15R2 gates/notes still say 57.
# Phase:   phase0_foundation
# Files:   v15R2/RELEASE_GATES.md, v15R2/release_notes_v15R2.md
# Depends: none
...
cd "$ROOT"
GATES="v15R2/RELEASE_GATES.md"
NOTES="v15R2/release_notes_v15R2.md"
CHANGED=0
...
echo "[PASS] 052: v15R2 docs now reference 69 tunables"

/* GTK4-PREP: zero GUI headers in scene — minimal direct includes.
 * This TU still touches UI selection state (selected_object) for legacy
 * shim compatibility; include only the tiny selector/state headers. */
